   ...
   digitalWrite(LED_BUILTIN, LOW);
    if(sensorFlag == LOW){
      ...
      sensorFlag = HIGH;
       ...
       SensorData();
      if(( sensorValues[4] > 900 && sensorValues[4] < 980)||( sensorValues[3] > 900 && sensorValues[3] < 980)){
        Serial.println("Forward");
          forward();
        }
       else if ((sensorValues[7]>900 && sensorValues[7]< 980 )|| (sensorValues[6]> 900 && sensorValues[6]<980)) { 
        Serial.println("LEFT");
          left();
        }
       else if ((sensorValues[1]> 900 && sensorValues[1]< 980) || (sensorValues[0] < 980 && sensorValues[0]> 900)) {
